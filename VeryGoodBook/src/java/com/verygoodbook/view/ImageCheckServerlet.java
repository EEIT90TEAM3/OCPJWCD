 ...
 */
//@WebServlet(name = "ImageCheckServerlet", urlPatterns = {"/images/check.jpg"})
public class ImageCheckServerlet extends HttpServlet {
    private int len = 6;
    public void init() {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //2.把字串變成圖
        BufferedImage image = generateImage(rand, w, 20);

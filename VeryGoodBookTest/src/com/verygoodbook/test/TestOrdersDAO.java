...
//            Order order2 = dao.get(2);
//            System.out.println("order2 = " + order2);
            
            System.out.println("list(A1123456781): " + dao.getOrdersByCustomer("A223456781"));
            
        } catch (Exception ex) {
            Logger.getLogger(TestOrdersDAO.class.getName()).log(Level.SEVERE, null, ex);
        }

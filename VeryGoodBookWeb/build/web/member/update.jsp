        ...
        <div id="article">
            ...
            <form action='update.do' method='POST'>
                ...
                <p> 
                    ...
                    <input type='password' name='password1' id='pwd1' minlength="6" maxlength="20"><br>
                    <label for='pwd2'>確認密碼:</label>
                    <input type='password' name='password2' id='pwd2' minlength="6" maxlength="20">
                </p>
                <p>
                ...
                <p>
                    ...
                    <input type='radio' name='gender' value='M' id='male' required 
                           <%= request.getParameter("gender") == null
                                   || (request.getParameter("gender").charAt(0) == Customer.FEMALE) ? 
                                (request.getMethod().equalsIgnoreCase("GET") && member.getGender() == Customer.MALE?"checked":"") 
                                :"checked"%>><label for='male'>男</label>
                    <input type='radio' name='gender' value='F' id='female' required
                           <%= request.getParameter("gender") == null
                                   || (request.getParameter("gender").charAt(0) == Customer.MALE) ? 
                                (request.getMethod().equalsIgnoreCase("GET") && member.getGender() == Customer.FEMALE?"checked":"") : "checked"%>
                           ><label for='female'>女</label>
                </p>

                <p>
                    <%= member.getBirthday()!=null?member.getBirthday().getClass().getName():""%>                    
                ...
                <p>
                    ...
                    <input type='text' name='address' id='address'
                           value="<%= request.getParameter("address") == null ? member.getAddress() : request.getParameter("address")%>">
                </p>
                <p>
                    <label for='married'>婚姻狀況:</label>
                    <input type='checkbox' name='married' id='married' 
                           <%= request.getParameter("married") == null ? (member.isMarried()?"checked":"") : "checked"%>><label for='married'>已婚</label>
                </p>
                <p>
